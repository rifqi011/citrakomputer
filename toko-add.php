                                ...
                                <div class="row">
                                    <div class="col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="toko_teks_nota_servis_masuk" id="input toko_teks_nota_servis_masuk" class="form-control" rows="3" required="required"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6">
                                        <div class="form-group">
                                            <label for="toko_teks_nota_servis_ambil">Teks Nota Servis Ambil</label>
                                            <textarea name="toko_teks_nota_servis_ambil" id="input toko_teks_nota_servis_ambil" class="form-control" rows="3" required="required"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
