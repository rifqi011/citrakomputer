...
<div class="row">
        ...
        <div class="form-group">
            ...
            <select class="form-control select2bs3" required="" name="ds_customer_id" id="ds_customer_id">
                ...
                <?php foreach ($customer as $ctr) : ?>
                    <?php if ($ctr['customer_id'] > 1 && $ctr['customer_nama']) { ?>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="form-group">
            ...
            <textarea name="ds_keterangan" id="textarea" class="form-control" rows="3" placeholder="Keterangan dari customer tentang keluhan barang" required></textarea>
        </div>
    </div>
    <div class="col-md-6 col-lg-4">
        <div class="form-group">
